...
public class ApplicationRunner {
    // Accessing the play.txt from task1
String fileLocation = System.getProperty("user.dir");
String dataPath = fileLocation + File.separator + "play.txt";
   

// Command for counting the letters
...
// Due to scope the current char is located outside the while loop
            int charInt;
// Read each character sequentially as an int
//The result returned is -1 at the end of the file when while loop ends.
...
//  IOException shouldn't be thrown at this point
